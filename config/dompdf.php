...
return [
    ...
    */
    ...
    'options' => [
         ...
         */
        // Temporary render files live inside the project rather than the system
        // temp directory, which other processes can read and which may be swept
        // mid-request.
        'temp_dir' => storage_path('app/private/dompdf'),
